...
output: 
  prettydoc::html_pretty:
    ...
    toc: true
vignette: >
  %\VignetteIndexEntry{MotrpacBicQC}
...
Download and install [R](https://mirror.las.iastate.edu/CRAN/) and [RStudio](https://rstudio.com/products/rstudio/download/) (free version)
...
- Install `MotrpacBicQC` package from github
  ...
  T55/
   HILICPOS/ 
    ...
    PROCESSED_20190725/
     ...
     NAMED/results_metabolites_named_[cas_specific_labeling].txt 
     NAMED/metadata_metabolites_named_[cas_specific_labeling].txt
     NAMED/metadata_sample_named_[cas_specific_labeling].txt 
     NAMED/metadata_experimentalDetails_named_[cas_specific_labeling].txt
     UNNAMED/results_metabolites_unnamed_[cas_specific_labeling].txt 
     UNNAMED/metadata_metabolites_unnamed_[cas_specific_labeling].txt
     UNNAMED/metadata_sample_unnamed_[cas_specific_labeling].txt 
     UNNAMED/metadata_experimentalDetails_unnamed_[cas_specific_labeling].txt
```
...
Alternatively, each individual dataset can also be provided:
